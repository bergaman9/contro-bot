...
TURKISH_PROFANITY_WORDS = ["abaza", "abazan", "ag", "a\u011fz\u0131na s\u0131\u00e7ay\u0131m", "ahmak", "allah",
                           ...
                           "babas\u0131 pezevenk", "baca\u011f\u0131na s\u0131\u00e7ay\u0131m", "bac\u0131na",
                           "bac\u0131n\u0131", "bac\u0131n\u0131n", "bacini", "bacn", "bacndan", "bacy", "bastard",
                           "basur", "beyinsiz", "b\u0131z\u0131r", "bitch", "biting", "bok", "boka", "bokbok",
                           "bok\u00e7a", "bokhu", "bokkkumu", "boklar", "boktan", "boku", "bokubokuna", "bokum",
                           ...
                           "sikilesice", "sikilmi", "sikilmie", "sikilmis", "sikilmi\u015f", "sikilsin", "sikim",
                           ...
                           "sikiyim", "sikiym", "sikiyorum", "sikkim", "sikko", "sikleri", "sikleriii", "sikli", "sikm",
                           "sikmek", "sikmem", "sikmiler", "sikmisligim", "siksem", "sikseydin", "sikseyidin", "siksin",
                           "siksinbaya", "siksinler", "siksiz", "siksok", "siksz", "sikt", "sikti", "siktigimin",
                           "siktigiminin", "sikti\u011fim", "sikti\u011fimin", "sikti\u011fiminin", "siktii", "siktiim",
                           "siktiimin", "siktiiminin", "siktiler", "siktim", "siktim", "siktimin", "siktiminin",
                           "siktir", "siktir et", "siktirgit", "siktir git", "siktirir", "siktiririm", "siktiriyor",
                           "siktir lan", "siktirolgit", "siktir ol git", "sittimin", "sittir", "skcem", "skecem",
                           "skem", "sker", "skerim", "skerm", "skeyim", "skiim", "skik", "skim", "skime", "skmek",
                           "sksin", "sksn", "sksz", "sktiimin", "sktrr", "skyim", "slaleni", "sokam", "sokar\u0131m",
                           "sokarim", "sokarm", "sokarmkoduumun", "sokay\u0131m", "sokaym", "sokiim",
                           "soktu\u011fumunun", "sokuk", "sokum", "soku\u015f", "sokuyum", "soxum", "sulaleni",
                           "s\u00fclaleni", "s\u00fclalenizi", "s\u00fcrt\u00fck", "\u015ferefsiz",
                           "\u015f\u0131ll\u0131k", "taaklarn", "taaklarna", "tarrakimin", "tasak", "tassak",
                           "ta\u015fak", "ta\u015f\u015fak", "tipini s.k", "tipinizi s.keyim", "tiyniyat", "toplarm",
                           "topsun", "toto\u015f", "vajina", "vajinan\u0131", "veled", "veledizina", "veled i zina",
                           "verdiimin", "weled", "weledizina", "whore", "xikeyim", "yaaraaa", "yalama", "yalar\u0131m",
                           "yalarun", "yaraaam", "yarak", "yaraks\u0131z", "yaraktr", "yaram", "yaraminbasi", "yaramn",
                           "yararmorospunun", "yarra", "yarraaaa", "yarraak", "yarraam", "yarraam\u0131", "yarragi",
                           "yarragimi", "yarragina", "yarragindan", "yarragm", "yarra\u011f", "yarra\u011f\u0131m",
                           "yarra\u011f\u0131m\u0131", "yarraimin", "yarrak", "yarram", "yarramin",
                           "yarraminba\u015f\u0131", "yarramn", "yarran", "yarrana", "yarrrak", "yavak", "yav\u015f",
                           "yav\u015fak", "yav\u015fakt\u0131r", "yavu\u015fak", "y\u0131l\u0131\u015f\u0131k",
                           "yilisik", "yogurtlayam", "yo\u011furtlayam", "yrrak", "z\u0131kk\u0131m\u0131m", "zibidi",
                           "zigsin", "zikeyim", "zikiiim", "zikiim", "zikik", "zikim", "ziksiiin", "ziksiin",
                           "zulliyetini", "zviyetini"]
...
class Moderation(commands.Cog):
    ...
    async def filter(self, ctx, profanity: bool = None, only_link_channels: commands.Greedy[discord.TextChannel] = None,
                     only_image_channels: commands.Greedy[discord.TextChannel] = None,
                     only_video_channels: commands.Greedy[discord.TextChannel] = None, reset: bool = False):
    ...
    async def kick(self, ctx, member: discord.Member, *, reason="None"):
        ...
        await ctx.send(embed=create_embed(description=member.mention + " has been kicked from Türk Oyuncu Topluluğu!",
                                          color=discord.Colour.red()))
        try:
            await member.send(embed=create_embed(description=f"You have been kicked from {member.guild.name}!",
                                                 color=discord.Colour.red()))
        except:
            await ctx.send(
                embed=create_embed(description="The member has their dms closed.", color=discord.Colour.red()))
    ...
    async def ban(self, ctx, member: discord.Member, *, reason="None"):
        ...
        try:
            await member.send(embed=create_embed(description=f"You have been banned from {member.guild.name}!",
                                                 color=discord.Colour.red()))
        except:
            await ctx.send(
                embed=create_embed(description="The member has their dms closed.", color=discord.Colour.red()))
        ...
        for ban_entry in banned_users:
            ...
            if (user.name, user.discriminator) == (member_name, member_discriminator):
                ...
                await ctx.channel.send(
                    create_embed(description=f"{user.mention} has been unbanned!", color=discord.Colour.dark_gray()))
    ...
    async def clear(self, ctx, amount: str):
        ...
        message = await ctx.send(
            embed=create_embed(description=f"**{amount}** messages cleared!", color=discord.Colour.green()))
        time.sleep(3)
        await message.delete()
    ...
    async def set_nick(self, ctx, member: discord.Member, nick):
        ...
        await ctx.send(embed=create_embed(description=f"Nickname was set to {nick} for {member.mention}",
    ...
    async def reset_nick(self, ctx, member: discord.Member = None):
        ...
        await ctx.send(
            embed=create_embed(description=f"Nickname was reset for {member.mention}", color=discord.Colour.green()))
    ...
    async def send_dm(self, ctx, member: discord.Member, *, message):
        ...
        await ctx.send(
            embed=create_embed(description=f"Message was sent to {member.mention}", color=discord.Colour.green()))
